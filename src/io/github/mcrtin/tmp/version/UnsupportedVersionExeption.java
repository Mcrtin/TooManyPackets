...
public class UnsupportedVersionExeption extends RuntimeException {
	...
	/**
	 * Constructs an {@code UnsupportedVersionExeption} with no detail message.
	 */
	...
	/**
	 * Constructs an {@code UnsupportedVersionExeption} with the specified detail
	 * message.
	 *
	 * @param message the detail message.
	 */
	public UnsupportedVersionExeption(String message) {
		super(message);
	}
	...
	@java.io.Serial
	private static final long serialVersionUID = 1608732118223923482L;
